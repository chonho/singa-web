#ifndef INCLUDE_TESTER_TESTER_H_
#define INCLUDE_TESTER_TESTER_H_
...
class Tester{
 ...
 protected:
   ...
   */
  void CreateWorkers(int nthread, const JobProto& jobConf, vector<Classifier*>& classifiers);
  //CLEEvector<Classifier*> CreateWorkers(int nthread, const JobProto& jobConf);
