#ifndef SINGA_TRAINER_CLASSIFIER_H_
#define SINGA_TRAINER_CLASSIFIER_H_
...
/**
 * The Classifier class which runs the training algorithm.
 ...
 * algorithms, e.g., the BPClassifier/CDClassifier/BPTTWorker implements the BP/CD/BPTT
 * algorithm respectively.
 */
class Classifier {
 public:
  static Classifier* Create(const JobProto& proto);
  /**
   ...
   */
  virtual void TestOneBatch(int step, Metric* perf)=0;
...
#endif  // SINGA_TRAINER_CLASSIFIER_H_
